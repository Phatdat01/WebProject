...
<link href="<c:url value="/assets/css/mystyle5.css " />"
	rel="stylesheet">
...
<body>
	...
	<div class="form_content">
		...
		<div class="add__content">
			...
			<form class="form__content" id="form-1"
				action="/Test-Server/addcontentcontroller" method="Post">
				<div class="form__name">
					<label class="label_form">Title</label>
					<!-- <p> title</p> -->
					<input type="text" id="title" rule="isRequired|min:10|max:200"
						class="filed__name" name="title" placeholder="Enter the title">
				...
				<div class="form__name">
					...
					<!-- <p> Brief</p> -->
					<textarea id="brief" name="brief" rule="isRequired|min:30|max:150"
						class="filed__name" placeholder=" " style="height: 100px"></textarea>
					<span class="form__message"></span>
				</div>
				...
				<div class="form__name">
					...
					<textarea id="content" name="content"
						rule="isRequired|min:50|max:1000" class="filed__name"
						placeholder=" " style="height: 180px"></textarea>
					<span class="form__message"></span>
				</div>
				<div class="form__name">
